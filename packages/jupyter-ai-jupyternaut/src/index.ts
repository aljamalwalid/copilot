...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  description:
    'Cloudera Copilot — assistant in JupyterLab (built on Jupyter AI).',
  autoStart: true,
    ...
    app.commands.addCommand(CommandIDs.openAiSettings, {
      execute: () => {
        if (!aiSettings || aiSettings.isDisposed) {
          ...
          aiSettings.title.label = 'Cloudera Copilot settings';
          aiSettings.title.caption = 'Cloudera Copilot settings';
      ...
      label: 'Cloudera Copilot settings'
    });
